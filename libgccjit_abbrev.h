...
#define gcc_location gcc_jit_context_new_location
...
#define GCC_T_INT16 GCC_JIT_TYPE_INT8_T
...
#define gcc_struct_type gcc_jit_struct_as_type
#define gcc_struct_set_fields gcc_jit_struct_set_fields
#define gcc_struct_get_field gcc_jit_struct_get_field
#define gcc_struct_field_count gcc_jit_struct_get_field_count
...
#define GCC_UNARY_OP_MINUS GCC_JIT_UNARY_OP_MINUS
#define GCC_UNARY_OP_BITWISE_NEGATE GCC_JIT_UNARY_OP_BITWISE_NEGATE
#define GCC_UNARY_OP_LOGICAL_NEGATE GCC_JIT_UNARY_OP_LOGICAL_NEGATE
#define GCC_UNARY_OP_ABS GCC_JIT_UNARY_OP_ABS
#define gcc_unary_op gcc_jit_context_new_unary_op
typedef enum gcc_jit_binary_op gcc_binary_op_e;
#define GCC_BINARY_OP_PLUS GCC_JIT_BINARY_OP_PLUS
#define GCC_BINARY_OP_MINUS GCC_JIT_BINARY_OP_MINUS
#define GCC_BINARY_OP_MULT GCC_JIT_BINARY_OP_MULT
#define GCC_BINARY_OP_DIVIDE GCC_JIT_BINARY_OP_DIVIDE
#define GCC_BINARY_OP_MODULO GCC_JIT_BINARY_OP_MODULO
#define GCC_BINARY_OP_BITWISE_AND GCC_JIT_BINARY_OP_BITWISE_AND
#define GCC_BINARY_OP_BITWISE_XOR GCC_JIT_BINARY_OP_BITWISE_XOR
#define GCC_BINARY_OP_BITWISE_OR GCC_JIT_BINARY_OP_BITWISE_OR
#define GCC_BINARY_OP_LOGICAL_AND GCC_JIT_BINARY_OP_LOGICAL_AND
#define GCC_BINARY_OP_LOGICAL_OR GCC_JIT_BINARY_OP_LOGICAL_OR
#define GCC_BINARY_OP_LSHIFT GCC_JIT_BINARY_OP_LSHIFT
#define GCC_BINARY_OP_RSHIFT GCC_JIT_BINARY_OP_RSHIFT
...
#define gcc_eval gcc_jit_block_add_eval
...
#define gcc_type_is_pointer gcc_jit_type_is_pointer
#define gcc_type_dyncast_vector gcc_jit_type_dyncast_vector
#define gcc_type_is_struct gcc_jit_type_is_struct
