...
void predeclare_def_types(env_t *env, ast_t *def, bool lazy)
{
    if (def->tag == StructDef) {
        ...
        sss_type_t *t = Type(StructType, .filename=sss_get_file_pos(def->file, def->start),
        ...
        sss_type_t *t = Type(TaggedUnionType, .filename=sss_get_file_pos(def->file, def->start),
        ...
        sss_type_t *variant_t = Type(VariantType, .filename=sss_get_file_pos(def->file, def->start),
...
void predeclare_def_funcs(env_t *env, ast_t *def)
{
    ...
    if (def->tag == FunctionDef) {
        ...
        sss_type_t *variant_t = variant_of->tag == StructType ?
            Type(StructType, .filename=sss_get_file_pos(def->file, def->start),
            ...
            : Type(VariantType, .filename=sss_get_file_pos(def->file, def->start),
