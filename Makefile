...
LIBFILE=lib$(NAME).so
CFILES=span.c files.c parse.c ast.c environment.c types.c typecheck.c units.c compile/math.c compile/blocks.c compile/expr.c compile/functions.c compile/helpers.c compile/arrays.c compile/loops.c compile/modules.c compile/program.c compile/ranges.c util.c libblang/list.c libblang/utils.c libblang/string.c
HFILES=span.h files.h parse.h ast.h environment.h types.h typecheck.h units.h compile/compile.h compile/modules.h util.h libblang/list.h libblang/string.h
OBJFILES=$(CFILES:.c=.o)
